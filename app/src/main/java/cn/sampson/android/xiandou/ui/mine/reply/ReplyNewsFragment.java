...
public class ReplyNewsFragment extends BaseFragment implements IView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView() {
        ...
        mAdapter.setOnLoadMoreListener(new QuickRecycleViewAdapter.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                page++;
                mPresenter.getMyReply("2", page, num);
            }
        });
    ...
    class MyReplyPresenterImpl extends BasePresenter<ReplyNewsFragment> implements MyReplyCommentPresenter {

        public MyReplyPresenterImpl(ReplyNewsFragment view, ViewGroup rootView) {
            super(view, rootView);
        }
