package cn.sampson.android.xiandou.widget.timepicker;
...
import cn.sampson.android.xiandou.widget.timepicker.adapter.WheelAdapter;
import cn.sampson.android.xiandou.widget.timepicker.common.InertiaTimerTask;
import cn.sampson.android.xiandou.widget.timepicker.common.LineConfig;
import cn.sampson.android.xiandou.widget.timepicker.common.MessageHandler;
import cn.sampson.android.xiandou.widget.timepicker.common.OnItemPickedRunnable;
import cn.sampson.android.xiandou.widget.timepicker.common.SmoothScrollTimerTask;
import cn.sampson.android.xiandou.widget.timepicker.listener.OnItemPickListener;
import cn.sampson.android.xiandou.widget.timepicker.listener.WheelViewGestureListener;
import cn.sampson.android.xiandou.widget.timepicker.model.IPickerViewData;
...
//        AT MOST：父节点要求其子节点的大小不能超过某个最大值，其子节点以及其他子孙节点的大小都需要小于这个值
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < adapter.getItemsCount(); i++) {
            ...
            //通过循环遍历，最终得到item中text的width和height的最大值
