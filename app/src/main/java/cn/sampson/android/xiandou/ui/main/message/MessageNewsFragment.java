...
public class MessageNewsFragment extends BaseFragment implements IView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView() {
        ...
        mAdapter.setOnLoadMoreListener(new QuickRecycleViewAdapter.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                page++;
                mPresenter.getMessageList("2", page, num);
            }
        });
    ...
    class MessagePresenterImpl extends BasePresenter<MessageNewsFragment> implements MessagePresenter {

        public MessagePresenterImpl(MessageNewsFragment view, ViewGroup rootView) {
            super(view, rootView);
        }
