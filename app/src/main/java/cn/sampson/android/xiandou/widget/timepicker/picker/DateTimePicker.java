package cn.sampson.android.xiandou.widget.timepicker.picker;
...
import cn.sampson.android.xiandou.widget.timepicker.WheelListView;
import cn.sampson.android.xiandou.widget.timepicker.WheelView;
import cn.sampson.android.xiandou.widget.timepicker.adapter.ArrayWheelAdapter;
...
import cn.sampson.android.xiandou.widget.timepicker.utils.LogUtils;
...
public class DateTimePicker extends WheelPicker {
    ...
    public String getSelectedHour() {
        if (timeMode != NONE) {
            return hours.get(selectedHourIndex);
        }
        return "";
    }
    ...
    public String getSelectedMinute() {
        if (timeMode != NONE) {
            return minutes.get(selectedMinuteIndex);
        }
        return "";
    }
