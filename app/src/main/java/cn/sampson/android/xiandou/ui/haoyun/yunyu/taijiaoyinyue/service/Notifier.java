...
import cn.sampson.android.xiandou.ui.haoyun.yunyu.taijiaoyinyue.PlayActivity;
import cn.sampson.android.xiandou.ui.haoyun.yunyu.taijiaoyinyue.receiver.StatusBarReceiver;
...
public class Notifier {
    ...
    public static void showPlay(Musics music) {
        playService.startForeground(NOTIFICATION_ID, buildNotification(playService, music, true));
    }

    public static void showPause(Musics music) {
    ...
    private static RemoteViews getRemoteViews(Context context, Musics music, boolean isPlaying) {
        String title = music.name;
        String subtitle = context.getString(R.string.music_notify_subtitle, String.valueOf(music.month));

        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.notification);
        remoteViews.setImageViewResource(R.id.iv_icon, R.mipmap.ic_music);
