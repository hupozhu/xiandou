package cn.sampson.android.xiandou.widget.babushkatext;/*
...
public class BabushkaText extends TextView {
    ...
    private void applySpannablesTo(Piece aPiece, SpannableString finalString, int start, int end) {
        ...
        if(aPiece.clickable != null){
            finalString.setSpan(aPiece.clickable ,start ,end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
    ...
    public static class Piece {
        ...
        public static class Builder {
            ...
            public Builder clickable(View.OnClickListener listener){
                this.clickable = new Clickable(listener);
                return this;
            }
