...
/*public*/ class BaseAdapterHelper {
    ...
    public static BaseAdapterHelper get(View convertView, ViewGroup parent, int layoutId) {
        return get(convertView, parent, layoutId, -1);
    }

    public static BaseAdapterHelper get(View convertView, ViewGroup parent, int layoutId, int position) {
        if (convertView == null) {
