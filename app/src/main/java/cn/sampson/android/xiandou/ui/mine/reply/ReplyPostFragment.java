...
public class ReplyPostFragment extends BaseFragment implements IView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView() {
        mPresenter = new MyReplyPresenterImpl(this, viewRoot);
        ...
        mAdapter.setOnLoadMoreListener(new QuickRecycleViewAdapter.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                page++;
                mPresenter.getMyReply("1", page, num);
            }
        });
    ...
    class MyReplyPresenterImpl extends BasePresenter<ReplyPostFragment> implements MyReplyCommentPresenter {

        public MyReplyPresenterImpl(ReplyPostFragment view, ViewGroup rootView) {
            super(view, rootView);
        }
        ...
        @Override
        public void getMyReply(String path, int page, int num) {
            requestData(RetrofitWapper.getInstance().getNetService(UserApi.class).getComments(path, page, num), GET_MY_REPLY);
        }
    }
}
