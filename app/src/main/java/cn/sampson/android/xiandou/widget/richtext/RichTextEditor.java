package cn.sampson.android.xiandou.widget.richtext;
...
import cn.sampson.android.xiandou.widget.richtext.editimage.EditImageView;
...
import cn.sampson.android.xiandou.widget.richtext.editimage.RichImageLayout;
...
public class RichTextEditor extends ScrollView {
    ...
    public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int horizontalPadding = dip2px(context, 15);
        int verticalPadding = dip2px(context, 5);
        allLayout.setPadding(horizontalPadding, verticalPadding, horizontalPadding, verticalPadding);//设置间距，防止生成图片时文字太靠边，不能用margin，否则有黑边
    ...
    public EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout._rich_edittext, null);
    ...
    private RelativeLayout createImageLayout() {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout._edit_imageview, null);
     ...
     * 插入一张图片
     */
    public void insertImage(Uri imagePath) {
    ...
    public int tryIfSuccessAndReUpload() {
        ...
        for (int i = 0; i != viewCount; ++i) {
            View childView = allLayout.getChildAt(i);
     ...
     * 在特定位置添加ImageView
     */
    public void addImageViewAtIndex(final int index, Uri imagePath) {
        ...
        imageView.setImageAndUpload(imagePath);
    ...
    public List<EditData> buildEditData() {
        ...
        for (int index = 0; index < num; index++) {
            ...
            if (itemView instanceof EditText) {
                ...
                EditImageView item = (EditImageView) itemView.findViewById(R.id.edit_imageView);
                itemData.imagePath = item.getUrl();
            }
