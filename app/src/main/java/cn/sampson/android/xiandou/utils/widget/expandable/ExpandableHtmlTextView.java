...
package cn.sampson.android.xiandou.utils.widget.expandable;
...
import cn.sampson.android.xiandou.utils.widget.htmlParseText.HtmlTextView;
...
public class ExpandableHtmlTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setText(@Nullable CharSequence text) {
        mRelayout = true;
        mTv.setHtmlFromString(text.toString(), false);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.mipmap.ss_ic_expand_more);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.mipmap.ss_ic_expand_less);
        }
    ...
    private void findViews() {
        mTv = (HtmlTextView) findViewById(R.id.expandable_text);
